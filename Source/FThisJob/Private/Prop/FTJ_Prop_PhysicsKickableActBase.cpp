...
void AFTJ_Prop_PhysicsKickableActBase::BeginPlay()
{
    //Delegate to Actor
    Super::BeginPlay();
    //Subscribe to hits
    GetStaticMeshComponent()->OnComponentHit.AddDynamic(this , &AFTJ_Prop_PhysicsKickableActBase::OnHit);
}

void AFTJ_Prop_PhysicsKickableActBase::OnHit(UPrimitiveComponent * InThisComponent , AActor * InActor , UPrimitiveComponent * InThatComponent , FVector InImpulse , FHitResult const& InResult)
{
