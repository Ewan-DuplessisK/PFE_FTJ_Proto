#include"Prop/FTJ_Prop_PhysicsReactingActBase.h"

#include"Prop/FTJ_Prop_PropCompBase.h"

void AFTJ_Prop_PhysicsReactingActBase::BeginPlay()
{
    //Delegate to Actor
    Super::BeginPlay();
    //Subscribe to hits
    GetStaticMeshComponent()->OnComponentHit.AddDynamic(this , &AFTJ_Prop_PhysicsReactingActBase::OnHit);
}

void AFTJ_Prop_PhysicsReactingActBase::OnHit(UPrimitiveComponent * InThisComponent , AActor * InActor , UPrimitiveComponent * InThatComponent , FVector InImpulse , FHitResult const& InResult)
{
