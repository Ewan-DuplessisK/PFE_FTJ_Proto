...
#include"FTJ_Prop_PhysicsReactingCompBase.generated.h"

//A UFTJ_Prop_PhysicsReactingComp base compatibility layer.
UCLASS() class FTHISJOB_API UFTJ_Prop_PhysicsReactingCompBase : public UFTJ_Prop_PropComp
{
    GENERATED_BODY()
