...
#include"FTJ_Prop_StaticKickableActBase.generated.h"

//An AFTJ_Prop_StaticKickableAct base compatibility layer.
UCLASS() class FTHISJOB_API AFTJ_Prop_StaticKickableActBase : public AStaticMeshActor
{
    GENERATED_BODY()
