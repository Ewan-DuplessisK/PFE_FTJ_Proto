...
#include"FTJ_Prop_StaticKickableCompBase.generated.h"

//A UFTJ_Prop_StaticKickableComp base compatibility layer.
UCLASS() class FTHISJOB_API UFTJ_Prop_StaticKickableCompBase : public UFTJ_Prop_PropComp
{
    GENERATED_BODY()
