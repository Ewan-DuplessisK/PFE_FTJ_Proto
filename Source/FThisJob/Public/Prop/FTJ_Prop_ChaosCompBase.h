...
#include"FTJ_Prop_ChaosCompBase.generated.h"

//A UFTJ_Prop_ChaosComp base compatibility layer.
UCLASS() class FTHISJOB_API UFTJ_Prop_ChaosCompBase : public UFTJ_Prop_PropComp
{
    GENERATED_BODY()
