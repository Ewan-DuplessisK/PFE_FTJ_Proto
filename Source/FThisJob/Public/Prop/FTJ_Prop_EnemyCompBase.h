...
#include"FTJ_Prop_EnemyCompBase.generated.h"

//A UFTJ_Prop_EnemyComp base compatibility layer.
UCLASS() class FTHISJOB_API UFTJ_Prop_EnemyCompBase : public UFTJ_Prop_PropComp
{
    GENERATED_BODY()
